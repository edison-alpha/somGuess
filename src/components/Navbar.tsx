        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-3">
            <div className="relative flex items-center cursor-pointer" onClick={() => navigate('/') }>
              <img src={logo} alt="Somnia Guess Logo" className="h-14 w-auto" />
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-500/20 to-indigo-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              ...
              <div className="relative flex items-center space-x-2">
                <svg className="w-5 h-5 text-fuchsia-400 group-hover:text-fuchsia-300 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
